...
const POST_TYPES = [
    { id: 'disease', label: 'Disease Report', icon: Bug, color: 'text-red-600 bg-red-50', border: 'border-red-200', badge: 'bg-red-500' },
    ...
    { id: 'tip', label: 'Farm Tip', icon: Lightbulb, color: 'text-amber-600 bg-amber-50', border: 'border-amber-200', badge: 'bg-amber-500' },
    { id: 'success', label: 'Success Story', icon: Award, color: 'text-green-600 bg-green-50', border: 'border-green-200', badge: 'bg-green-500' },
    { id: 'help', label: 'Need Help', icon: HelpCircle, color: 'text-purple-600 bg-purple-50', border: 'border-purple-200', badge: 'bg-purple-500' },
];
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between flex-wrap gap-4">
                        <div>
                            ...
                            <p className="text-slate-500 font-semibold text-sm mt-1">Connect · Learn · Share with Indian Farmers</p>
                        </div>
                        <button
                    ...
                    <div className="flex items-center gap-3 mt-5 flex-wrap">
                        <span className="text-xs font-black text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                            <TrendingUp size={14} className="text-green-500" /> Trending:
                        </span>
                ...
                <div className="flex gap-3 mb-6 flex-wrap">
                    <div className="flex-1 min-w-[200px] flex items-center gap-3 bg-white border border-slate-200 rounded-2xl px-4 py-3 shadow-sm focus-within:border-green-400 focus-within:ring-2 focus-within:ring-green-100 transition-all">
                        ...
                        <input
                            ...
                            placeholder="Search posts, crops, farmers..." className="bg-transparent outline-none w-full text-sm font-semibold text-slate-700 placeholder:text-slate-300"
                        />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        {loading ? (
                            <div className="flex flex-col items-center justify-center py-20 gap-4 bg-white rounded-3xl border border-slate-100">
                                ...
                                <p className="text-slate-400 font-black uppercase tracking-widest text-xs">Loading Community...</p>
                            </div>
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex items-center gap-2 pt-4 border-t border-slate-50 flex-wrap">
                                                ...
                                                <button onClick={() => setExpandedPostId(isExpanded ? null : post.id)}
                                                    ...
                                                    {post.replies || 0} {isExpanded ? 'Hide' : 'Reply'}
                                                </button>
                                                            ...
                                                            <div className="flex gap-3">
                                                                ...
                                                                <div className="flex-1 flex gap-2">
                                                                    <input type="text" value={commentText} onChange={e => setCommentText(e.target.value)}
                                                                        ...
                                                                        placeholder="Write a reply..." className="flex-1 bg-slate-50 border border-slate-200 rounded-2xl px-4 py-2.5 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-green-400" />
                            ...
                            <div className="bg-white rounded-3xl p-20 text-center border-2 border-dashed border-slate-100">
                                ...
                                <p className="text-slate-400 font-black uppercase tracking-widest text-xs">No posts found</p>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="bg-gradient-to-br from-green-600 to-emerald-700 rounded-3xl p-6 text-white shadow-xl shadow-green-200">
                            <h3 className="font-black text-sm uppercase tracking-widest mb-4 opacity-80">Community</h3>
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    { label: 'Farmers', value: posts.length > 0 ? `${posts.length * 3}+` : '100+' },
                        ...
                        {/* Quick Post */}
                        <div className="bg-white rounded-3xl p-5 border border-slate-100 shadow-lg">
                            <h3 className="font-black text-xs uppercase tracking-widest text-slate-400 mb-3">Quick Share</h3>
                            <button onClick={() => setIsModalOpen(true)}
                                ...
                                🌿 Share a tip, disease, or question...
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-4 pb-4 sm:pb-0">
                        ...
                        <motion.div initial={{ scale: 0.9, opacity: 0, y: 40 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.9, opacity: 0, y: 40 }}
                            ...
                            <div className="flex items-center justify-between p-6 border-b border-slate-100">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-400 font-semibold">Post to All India Community</p>
                                    </div>
                                </div>
                            ...
                            <div className="p-6 space-y-5">
                                {/* Post Type Selector */}
                                <div>
                                    <p className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Post Type</p>
                                        ...
                                        {POST_TYPES.map(pt => {
                                            ...
                                            return (
                                                <button key={pt.id} type="button" onClick={() => setPostType(pt.id)}
                                                    ...
                                                    <Icon size={18} />
                                                    <span className="text-[9px] uppercase tracking-wide leading-tight text-center">{pt.label.split(' ')[0]}</span>
                                                </button>
                                            );
                                        })}
                                    </div>
                                ...
                                <textarea ref={textareaRef}
                                    ...
                                    placeholder={postType === 'disease' ? "Describe the disease you noticed — symptoms, affected leaves, crop..." : postType === 'tip' ? "Share a useful farming tip or technique..." : postType === 'help' ? "What help do you need? Describe your issue clearly..." : "What's on your mind, farmer?"}
                                    value={newPostContent} onChange={e => setNewPostContent(e.target.value)} autoFocus />

                                {/* Crop Tags */}
                                <div>
                                    <p className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Tag Crops (optional)</p>
